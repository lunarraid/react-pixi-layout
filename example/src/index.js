    ...
    return (
      ...
      >
        <Rectangle style={styles.header}>
          <Text
            text="An Absolutely Positioned Header"
            style={{ fill: "blue", fontSize: 32 }}
          />
        ...
        <Container style={styles.container}>
          ...
          >
            ...
            <Animated.Sprite
              texture="http://placekitten.com/200/300"
              style={{ height: "50%", alpha: this.animatedValue }}
            />
          </Animated.Rectangle>
